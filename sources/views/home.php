...
<div class="container-fluid h-100 ">
    <div class="row justify-content-center h-100">
        <div class="col-md-6 p-0 bg-indigo h-md-100 white" id="yellow">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="list-bouton">
                                        <div class="btn btn-outline-primary add rounded-pill">Ajouter tâches</div>
            ...
            <button type="button" class="btn btn-outline-primary add_list rounded-pill" data-bs-toggle="modal" data-bs-target="#exampleModal">
        ...
        <div class="col-md-6 p-0 bg-indigo h-md-100 grey">
            <div class="title-bar">
                <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-incognito" viewBox="0 0 16 16">
            ...
            <p class="text-center" style="padding-left: 100px; padding-right: 100px;"><U>Connectez-vous</U> pour accéder à la liste de vos tâches personnelles</p>
        </div>
    </div>
</div>
</body>
